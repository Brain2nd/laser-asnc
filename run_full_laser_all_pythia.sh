...
# Known FP16 baselines (from earlier runs; skip re-measuring to save ~34min each)
declare -A FP16_BASELINE=(
  [70m]=40.8866
  [160m]=23.5037
  [410m]=13.9811
  [1b]=11.6084
